...
<%-- 
	자바빈이란?
		요청 발생시 화면으로부터 입력받은 데이터를 하나의 객체(DTO, VO)에 담아 편리하게 사용할 수 있습니다.
	...
	<jsp:useBean id=""></jsp:useBean> : 자바빈 생성
	<jsp:setProperty> : 자바빈 속성 저장
	<jsp:getProperty> : 자바빈 속성 추출
 --%>
<!-- 
 	id : 자바빈즈 이름
 	class : 패키지 명을 포함한 클래스명
 	scope : 저장될 영역
-->
