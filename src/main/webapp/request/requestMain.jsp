...
<h2>2. 클라이언트의 요청 매개변수 읽기</h2>
	<form action="RequestParameter.jsp" method="post">
		...
		<br>
		관심사 : <input type="checkbox" name="favo" value="eco" checked="checked"> 경제
			  <input type="checkbox" name="favo" value="pol"> 정치
			  <input type="checkbox" name="favo" value="ent"> 연예
		<br>
		자기소개 : <textarea rows="4" cols="30" name="intro">만나서 반갑습니다. 잘 부탁드려요~!</textarea>
		<br>
		<button>전송</button> <!-- 폼에 유일한 버튼인 경우 : 자동으로 submit 버튼이 됨 -->
	</form>
